                    ...
                    if (void 0 !== Xa) {
                        ...
                        for (da = Z.length; Y < da; Y++)
                            (ia = n.vertexNormalsModel[Y]),
                                ...
                                n.vertexNormalsModelView[Y].copy(
                                    ia
                                ).applyMatrix3(ca);
        ...
        F.parameters.normalMap
            ? ((E = THREE.ShaderLib.normalmap),
              ...
              F.parameters.displacementMap &&
                  ...
                  (B.uDisplacementScale.value =
                      F.parameters.displacementScale)),
            ...
            null === i.map
                ...
                ? ((Wa = p.near),
                  ...
                  (pa.r =
                      ...
                      pa.b =
                          1 -
                          k(a.positionScreen.z * a.positionScreen.w, Wa, ab)),
                  (Y.r =
                      Y.g =
                      Y.b =
                          1 -
                          k(d.positionScreen.z * d.positionScreen.w, Wa, ab)),
                  (da.r =
                      da.g =
                      da.b =
                          1 -
                          k(e.positionScreen.z * e.positionScreen.w, Wa, ab)),
                  la.addColors(Y, da).multiplyScalar(0.5),
                  (Fa = E(pa, Y, da, la)),
                  G(M, ca, qa, ha, ra, N, 0, 0, 1, 0, 0, 1, Fa))
                        ...
                        (n = b[c]),
                            n.onlyShadow ||
                                ...
                                n instanceof THREE.AmbientLight
                                    ...
                                    ? ((ca += 1),
                                      n.visible &&
                                          (La.getPositionFromMatrix(
                                              n.matrixWorld
                                          ),
                                          Qa.getPositionFromMatrix(
                            ...
                            if (
                                ...
                                if (H.numMorphTargets) {
                                    ...
                                    for (P = H.numMorphTargets; M < P; M++)
                                        H.__webglMorphTargetsBuffers.push(
                                            j.createBuffer()
                                        );
                                }
                                if (H.numMorphNormals) {
                                    ...
                                    for (P = H.numMorphNormals; M < P; M++)
                                        H.__webglMorphNormalsBuffers.push(
                                            j.createBuffer()
                                        );
                                }
                                N.info.memory.geometries++;
            ...
            (a = h * m + i),
                ...
                d
                    ? (f.push(new THREE.Face3(a, e, l)),
                      ...
                      g.push([n, s, r]),
                      g.push([s, p, r]))
                    : (f.push(new THREE.Face4(a, e, k, l)),
                      g.push([n, s, p, r]));
    this.computeCentroids();
    this.computeFaceNormals();
    this.computeVertexNormals();
                ...
                if (
                    ...
                    v.visible &&
                        ...
                        (!(
                            ...
                            v instanceof THREE.ParticleSystem
                        ) ||
                            !v.frustumCulled ||
            ...
            if (
                ...
                r.visible &&
                    (!(
                        ...
                        r instanceof THREE.ParticleSystem
                    ) ||
                        !r.frustumCulled ||
